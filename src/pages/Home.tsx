    ...
    <div className="w-full  bg-[rgb(13,13,13)] ">
      ...
      <div className="w-full px-48  py-32 text-[#b7ab98] ">
        ...
        <div className="text-6xl my-3">
          <p>
            Celebrated{" "}
            <span className="text-[rgb(235,89,57)]">watchmaker since 2015</span>
            . Passionate about, precision, craftsamanship, and timeless design.
            Consistently providing meticulous, high-quality service
          </p>
        </div>
      </div>
      <div className="w-full   py-32 text-[#b7ab98] ">
        ...
        <div className="text-4xl my-3 uppercase">
          ...
          <p className="w-full border-y border-[#b7ab98] px-24">
      ...
      <div className="w-full px-48  pt-32 pb-40 text-[#b7ab98] bg-[url('/images/work-1600.jpg')] bg-no-repeat bg-cover relative">
        ...
        <div className="text-7xl my-3">
          <p>
            ...
            watchmaking experience in a variety of watch styles , including
            luxury, sport, and vintage designs, while working with the majority
            of the market's major players to create exquisite timepieces.
          </p>
        </div>
